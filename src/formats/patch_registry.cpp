...
void PatchRegistry::register_defaults() {
  register_format(".gin",
                  {formats::gin::read_file, nullptr, "GIN"});
  register_format(".ginpkg",
                  {formats::ginpkg::read_file, nullptr, "GINPKG"});
  register_format(".dmp",
                  {formats::dmp::read_file,
                   formats::dmp::write_patch, "DMP"});
  register_format(".rym2612",
                  {formats::rym2612::read_file, nullptr, "RYM2612"});
  register_format(".fui",
                  {formats::fui::read_file, nullptr, "FUI"});
  register_format(".mml",
                  {formats::ctrmml::read_file, nullptr, "MML"});
}
