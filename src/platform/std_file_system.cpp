...
StdFileSystem::read_directory(const std::filesystem::path &path) const {
...
bool StdFileSystem::last_write_time(
...
StdFileSystem::open_write(const std::filesystem::path &path,
