...
// An upgrade from before the change log has no stored version either, and is
...
// Running an older build after a newer one must not claim an update.
...
// The leading v is optional on either side.
